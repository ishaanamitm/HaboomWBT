...
WebUI.click(findTestObject('My Account_Payment/Betting Activity/a_Sportsbook Betting History'))

WebUI.verifyElementText(findTestObject('My Account_Payment/Betting Activity/My Bets'), 'My Bets')
