...
WebUI.setText(findTestObject('My Account_Payment/Transfer Funds/To player'), '6366763704')

WebUI.click(findTestObject('My Account_Payment/Transfer Funds/Transfer button'))

WebUI.setText(findTestObject('My Account_Payment/Transfer Funds/Transfer Password'), 'Eternals@123')

WebUI.click(findTestObject('My Account_Payment/Transfer Funds/Verify and Transfer button'))
...
WebUI.click(findTestObject('My Account_Payment/Transaction history page/Betting Internal Withdrawal'))
