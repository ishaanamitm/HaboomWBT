...
WebUI.setText(findTestObject('My Account_Payment/Transfer Funds/transfer amount'), '')
...
WebUI.verifyElementText(findTestObject('My Account_Payment/Transfer Funds/Amount field should not be empty'), 
