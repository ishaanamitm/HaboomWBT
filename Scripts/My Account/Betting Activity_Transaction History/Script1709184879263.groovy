...
WebUI.click(findTestObject('My Account_Payment/Betting Activity/a_Transaction History'))

WebUI.verifyElementText(findTestObject('My Account_Payment/Betting Activity/Transaction History'), 'Transaction History')
