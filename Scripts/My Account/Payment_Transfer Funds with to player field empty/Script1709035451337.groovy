...
WebUI.setText(findTestObject('My Account_Payment/Transfer Funds/To player'), '')

WebUI.click(findTestObject('My Account_Payment/Transfer Funds/Transfer button'))

WebUI.verifyElementVisible(findTestObject('My Account_Payment/Transfer Funds/No to player error message'), 
