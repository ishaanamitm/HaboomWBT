...
WebUI.click(findTestObject('My Account_Payment/Betting Activity/a_My Casino Bets'))

WebUI.verifyElementText(findTestObject('My Account_Payment/Betting Activity/Casino Bets History'), 'CASINO BETS HISTORY')
