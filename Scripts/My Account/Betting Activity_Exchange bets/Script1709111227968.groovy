...
WebUI.click(findTestObject('Object Repository/My Account_Payment/Betting Activity/a_Exchange Bets'))

WebUI.verifyElementText(findTestObject('My Account_Payment/Betting Activity/Exchange Bets'), 'Exchange Bets')
