...
WebUI.click(findTestObject('My Account_Payment/Betting Activity/a_Exchange Betting History'))

WebUI.verifyElementText(findTestObject('My Account_Payment/Betting Activity/Betting History/div_Betting History'), 
    'Betting History')
