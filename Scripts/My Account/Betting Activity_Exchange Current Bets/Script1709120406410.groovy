...
WebUI.click(findTestObject('My Account_Payment/Betting Activity/a_Exchange Current Bets'))

WebUI.verifyElementText(findTestObject('My Account_Payment/Betting Activity/Current Bets'), 'Current Bets')
