...
WebUI.click(findTestObject('My Account_Payment/Betting Activity/a_Exchange Profit  Loss'))

WebUI.verifyElementText(findTestObject('My Account_Payment/Betting Activity/Betting Profit Loss'), 'Betting Profit & Loss')
