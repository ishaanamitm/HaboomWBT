...
WebUI.setText(findTestObject('My Account_Payment/Transfer Funds/Transfer Password'), '')

WebUI.click(findTestObject('My Account_Payment/Transfer Funds/Verify and Transfer button'))

WebUI.verifyElementText(findTestObject('My Account_Payment/Transfer Funds/Please enter password'), 
